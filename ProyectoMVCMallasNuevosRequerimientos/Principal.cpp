 ...
 *
 * La empresa Malla Fast es productora de dos tipos de mallas: mallas plana y
  mallas de rollo.
 ...
 *
 *   - PROMEDIO DE MONTO VENDIDO
 *
 *   - Considere
 *     Ademas de los datos suministrados por cliente tambien se conoce:
 *     el tipo de material de la malla: 1) liviano, 2)duplex y 3)robusto
 *     calcule el tipo de material mas vendido en METROS.
 *
 *
 */
