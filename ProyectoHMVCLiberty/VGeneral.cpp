...
double VGeneral:: LeerValidarNroDecimal(string msj, float valorinicial, float valorfinal)
{
	float po;
	do
	{
		...
		if(po < valorinicial or po > valorfinal)
		{
			cout<<"\n Dato no Valido! ";
		}


	} while (po < valorinicial or po > valorfinal);
	return po;
}
//---------------------------------------------------------------------------------------
