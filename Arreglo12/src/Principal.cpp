...
int IBuscarNombre(string Nombre, Seccion laSeccion);
...
{
	Alumno elAlumno;
    cout<< "LISTADO CONDICIONADO - Nota>48 \n";
	cout<< "   Nombre         Nota \n ";
	for(int i=0;i<MAX;i++)
	{
...
void ISSeccion(Seccion laSeccion)
{
	...
	int i;
	string Nom;
	cout<<"Diga el nombre del alumno que quiere buscar:"<<endl;
	cin>>Nom;
		i = IBuscarNombre(Nom,laSeccion);
		if(i==-1)
			cout<<"No existe alumno con ese nombre"<<endl;

				else
		cout<<"El alumno: "<<Nom<<" si puede inscribir Programacion I"<<endl;
