...
int Compania::getContTEM200()
{
	return ContCTEM200;
}

void Compania::CalcCantTEM(Cliente elCliente)
{
	if(elCliente.getCedula()<=4000000 and CalcTotal(elCliente)>200)
		ContCTEM200=ContCTEM200+1;
}

float Compania::CalcPorcTEM()
{
	float Porcentaje;
	Porcentaje=(ContCTEM200*100)/ContCl;
	return Porcentaje;
}
