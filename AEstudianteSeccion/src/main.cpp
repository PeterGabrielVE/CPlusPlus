 ...
 *
 *   5. De 100 estudiantes de una Sección se conoce su nota, el sexo y la edad. Escriba un
	programa que:
...
{
Estudiante elEst;
cout <<" LISTADO CONDICIONADO - ESTUDIANTES MASCULINOS CON NOTA >= PROMEDIO\n\n";
...
if (elEst.getSexo()=='M' and elEst.getNota() >= laSeccion.promediarN())
